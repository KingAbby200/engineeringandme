...
export const metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: '/favicon.ico', width: 1200, height: 630, alt: 'Engineering Tutorials' }],
  },
  twitter: { card: 'summary_large_image', title: 'Engineering & Me', description: 'Free engineering tutorials for all disciplines.', images: ['/favicon.ico'], creator: '@EngineeringandMe' },
